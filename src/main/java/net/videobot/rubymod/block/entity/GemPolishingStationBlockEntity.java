package net.videobot.rubymod.block.entity;
...
import net.videobot.rubymod.recipe.GemPolishingRecipe;
...
public class GemPolishingStationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    private boolean hasRecipe() {
        ...
        return recipe.isPresent() && canInsertAmountIntoOutputSlot(recipe.get().value().getResult(null))
                && canIntoOutputSlot(recipe.get().value().getResult(null).getItem());
    }
    ...
    private boolean canIntoOutputSlot(Item item) {
