...
import net.videobot.rubymod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingScreenHandler extends ScreenHandler {
    ...
    public GemPolishingScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf bug) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(bug.readBlockPos()),
