...
public class MetalDetectorItem extends Item {
    ...
    private boolean isValualbleBlock(BlockState state) {
        return state.isOf(Blocks.COPPER_ORE) ||state.isOf(Blocks.IRON_ORE) || state.isOf(Blocks.GOLD_ORE) || state.isOf(Blocks.DIAMOND_ORE) || state.isOf(Blocks.ANCIENT_DEBRIS);
    }
}
