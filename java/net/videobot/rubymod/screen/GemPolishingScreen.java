...
public class GemPolishingScreen extends HandledScreen<GemPolishingScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(RubyMod.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
    ...
    private void renderProgressArrow(DrawContext context, int x, int y) {
        if (handler.isCrafting()) {
            context.drawTexture(TEXTURE, x + 85, 7 + 30, 176, 0, 8, handler.getScaledProgress());
        }
    }
